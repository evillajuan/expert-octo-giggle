  ...
  if (ordered) {
    return (
      <div className="text-center py-20 px-4">
        ...
        <p className="font-round font-800 text-xl text-[#7A5A40] mb-8 max-w-sm mx-auto">
    ...
    <div className="max-w-4xl mx-auto">
        ...
        {STEP_LABELS.map((label, i) => (
          <div key={i} className="flex items-center flex-1">
            <div className="flex flex-col items-center">
              ...
              <span className={`font-round font-bold text-xs mt-1.5 hidden sm:block ${
                i === step ? 'text-rose' : 'text-[#C4A882]'
              }`}>
                {label}
              </span>
            </div>
      ...
      <div className="grid md:grid-cols-5 gap-6 items-start">
        ...
        <div className="md:col-span-3 bg-white rounded-4xl shadow-card p-6">
          ...
          {step === 0 && (
            <div>
              <h3 className="font-display text-3xl text-[#2C1A0E] mb-5">🎨 Design Your Hero</h3>
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  maxLength={20}
                  className="w-full rounded-2xl border-2 border-blush focus:border-rose outline-none
                             px-4 py-3 font-round font-bold text-[#2C1A0E] placeholder:text-gray-300
          ...
          {step === 2 && (
            <div>
              <h3 className="font-display text-3xl text-[#2C1A0E] mb-5">✨ Story Magic</h3>
